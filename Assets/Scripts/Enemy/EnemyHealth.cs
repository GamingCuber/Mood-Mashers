...
public class EnemyHealth : MonoBehaviour
{
    ...
    private EnemyKillTextUpdater killCountText;
    ...
    void Start()
    {
        ...
        killCountText = GameObject.FindGameObjectWithTag("EnemyKillCount").GetComponent<EnemyKillTextUpdater>();
    }
